...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int mode = EDGE_FLAGS[a.getInt(R.styleable.SwipeBackLayout_edge_flag, 4)];
     ...
     * callback's
     * {@link com.readboy.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.readboy.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
...
//            drawScrim(canvas, child);
    ...
    private void drawScrim(Canvas canvas, View child) {
        ...
        if ((mTrackingEdge & EDGE_LEFT) != 0) {
            ...
            canvas.clipRect(child.getLeft(), 0, getRight(), getHeight());
        }
    ...
    private void drawShadow(Canvas canvas, View child) {
        ...
        if ((mEdgeFlag & EDGE_TOP) != 0) {
            mShadowTop.setBounds(childRect.left, child.getTop() - 25,
                    childRect.right, childRect.top + mShadowTop.getIntrinsicHeight() - 23);
